...
L2DBaseModel.prototype = Object.create( PIXI.DisplayObjectContainer.prototype );
L2DBaseModel.prototype.constructor = L2DBaseModel;
...
{   
    ...
    */
    ...
    pm.loadLive2DModel(path, function(l2dModel) {
        ...
        thisRef.modelMatrix.setWidth(1);
