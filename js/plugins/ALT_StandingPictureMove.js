...
//パラメータをオブジェクトに格納
    ...
    $SPM_Live2d_CharaName_ini = String(parameters['Stand_1_CharacterName']);
	...
	//Live2d 表情変更 Slip 2016/07/15
        switch(args[const_SPM_PARA_expression]){
            case '表情1':
            $gameLive2d.setExpression('expression_00',0);
            break;
            case '表情2':
            $gameLive2d.setExpression('expression_01',1);
            break;
            case '表情3':
            $gameLive2d.setExpression('expression_02',2);
            break;
            case '表情4':
            $gameLive2d.setExpression('expression_03',3);
            break;
            case '表情5':
            $gameLive2d.setExpression('expression_04',4);
            break;
            case '表情6':
            $gameLive2d.setExpression('expression_05',5);
            break;
            case '表情7':
            $gameLive2d.setExpression('expression_06',6);
            break;
            case '表情8':
            $gameLive2d.setExpression('expression_07',7);
            break;
　　　　}
        ...
        if (SPM_Position !== '消去') {
            ...
            if (args[const_SPM_PARA_scale_y] === 'y％') {
            ...
            case 'スライド':
                  ...
                  if (args[const_SPM_PARA_time] === '時間') {
                    SPM_Duration = 10;
                  }else if (args[const_SPM_PARA_time] !== '時間') {
	...
	　　　//const_SPM_PARA_slidepatternの代入値は例外
              if (args[const_SPM_PARA_slidepattern] === '時間'){
